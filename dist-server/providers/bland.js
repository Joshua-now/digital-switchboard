...
export async function createCall(leadId, clientId, phone, instructions, transferNumber, agentId) {
    ...
    if (!baseUrl) {
        const msg = 'BASE_URL must be set to ONLY the domain and start with https:// (e.g. https://digital-switchboard-production.up.railway.app)';
